...
VALUES
  ...
  ('d4444444-4444-4444-4444-444444444444', 'Kyodo Taiko', 'KYODO_2026', 'b2222222-2222-2222-2222-222222222222', 'default');
...
VALUES
  ...
  ('f6666666-6666-6666-6666-666666666666', 'c3333333-3333-3333-3333-333333333333', 'b2222222-2222-2222-2222-222222222222', 'USER', 'Standard Member');
...
BEGIN
    ...
    SELECT id INTO enak_asayake_id FROM public.org_memberships WHERE user_id = 'b2222222-2222-2222-2222-222222222222' AND organization_id = 'c3333333-3333-3333-3333-333333333333';
