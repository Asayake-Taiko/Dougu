...
export interface IAuthService {
    ...
    updatePassword(user: User, currentPassword: string, newPassword: string): Promise<void>;
...
export const authService = MOCK_ENABLED ? new MockAuthService() : new AuthService();
